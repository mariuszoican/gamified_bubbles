...
#   3. Re-run: build_panels.py → compute_variables.py → hypothesis_tests.py
# ============================================================
...
# ── PATHS ─────────────────────────────────────────────────────────────────────
# NOTE: raw raw_data lives in a subfolder (marius_play_1) inside raw_data/.
...
# These derived columns must be created in build_panels.py immediately
